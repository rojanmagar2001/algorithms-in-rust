...
/// Enum representing possible errors that an occur while checking for isogram.
...
/// Counts the occurences of each alphabetic character in a given string.
///
/// This function takes a string slice as input. It counts how many times each alphabetic character
/// aooears in the input string and returns a hashnmap where the keys are characters and the values
